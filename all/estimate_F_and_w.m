function [est_F,w,phi_col,evl_pnt] = estimate_F_and_w( s_check, Tx_pos , Rx_pos,  ini_F , myKfunc  , mu_w , mu_f, Nc , clustering_type, reg_f_type, blind_ind ,lambda_W,rho)
%  
% 
% INPUT:
...
%   reg_f_type    regularization type for the SLF: 'T'= Tikhonov; 'S' = l_1; 'TV' = total variation 
%   lambda_W      Parameter to set the semi-minor axis of an ellipse in w function
